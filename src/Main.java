...
public class Main {
    ...
    public static void main(String[] args) {
        Coche coche = new Coche(); //Cuando se lee esta linea, se invoca el constructor
...
class Coche {
    ...
    public Coche() { //Creacion de Constuctor (opcional puede tener parametros)
        numeroDePuertas = 5; //Aca estoy inicializando en 5
        velocidadMaxima = 120;
